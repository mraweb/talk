    ...
    <form action="" method="post">
        <ul>
            <li>
                ...
                <input type="text" name="mailcadastro" id="mailcadastro" class="validate[required,custom[email]]" />
            </li>
            ...
            <li>
                ...
                <input type="text" name="radiocadastro" id="radiocadastro" />
            </li>

            <li>
                <label for="cidade">Cidade:</label>
                <select name="cidade" id="cidade" class="validate[required]">
                    <option value=""></option>
                </select>
            </li>
