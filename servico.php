                ...
                <li>
                    ...
                    <select name="sub-cat" id="servicoSubCategoria">
                    	<?php 
                    		...
                    		//$combobox->setIdServicoSubCategoria($listagem->getIdServicoSubCategoria());
...
<script type="text/javascript">
    ...
    function ckeckSubCategoria(){
alert("idServico: "+idServico);
alert("idSubCategoria: "+idSubCategoria);
    	var resp = true;
    	if(idServico <= 7 && idSubCategoria == ""){
			alert("Selecione uma Sub-Categoria");
			$('#servicoSubCategoria').focus();
			resp = false;
        }
		return resp;
    }
