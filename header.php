<header role="banner">
        <?php if ($url[0] == ""){ ?>
        <h1><a href="<?php echo URL;?>" title="Talk Radio - Programas de Radio" class="hidetxt">Talk Radio - Programas de Radio - Programetes para Radios</a></h1>
		<?php }else{ ?>
        <p class="logo"><a href="<?php echo URL;?>" title="Talk Rádio - Programas de Radio - Programetes para Radios"><img src="<?php echo URL;?>img/talkradio.png" alt="Talk Rádio - Programas de Radio" width="150" height="104" /></a></p>
        <?php } ?>
        ...
        <nav role="navigation">
            <ul>
                ...
                <li><a href="<?php echo URL;?>servicos" title="Serviços" class="bt-serv <?php if($url[0] == "servicos"){echo 'ativo6';} ?>">Serviços</a></li>
