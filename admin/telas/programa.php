...
include_once("../classe/Programa.php");
include_once("../funcoes/define.php");
	$listagem = new Programa();
	if($idAlteracao){
		$listagem->setId($idAlteracao);
		$listagem->geraDadosIdPrograma();
...
<div class="content">
    ...
    <form action="../classe/Programa.php" method="post" id="formPrograma" method="post" enctype="multipart/form-data">
        <ul class="form1">
