...
<div class="content">
	...
	<?php 
		if(!$_REQUEST['id']){
			echo '<p>Adicionar novo serviço com áudio:</p>';
		}else{
			echo '<p>Serviço com áudio: '.$listagem->getNome().'</p>';
		}
	?>
        ...
        <ul class="form1">
           ...
           <li>
                ...
                <?php 
                	...
                	$categoriaServico->setIdServico($idAlteracao);
                	$categoriaServico->checkboxCategoriaServico();
                ?>
            </li>
        ...
        <ul class="form1">
        	<li>
            	<input type="hidden" name="audio" value="COM" />
                <input type="image" src="img/btpublicar.jpg" name="Publicar" class="bt-adicionar" />
                    <?php 
                    	if(!$_REQUEST['id']){
                    		...
                    		echo '<input type="hidden" name="audio" value="COM" />';
