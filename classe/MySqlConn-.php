...
/*
	public function __construct(){
		...
		$this->pass = "";
		$this->dba = "talkradio";	
		self::connect(); // executa o metodo de conexao automaticamente ao herdar a classe
	}
*/

	public function __construct(){
		$this->host = "186.202.152.36";
		$this->user = "moduloradio18";
		$this->pass = "talkiopjkl10"; 
		$this->dba = "moduloradio18";	 
